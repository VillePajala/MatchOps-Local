...
const defaultProps = {
  ...
  onClose: jest.fn(),
  season: mockSeason,
  updateSeasonMutation: mockMutation() as unknown as UseMutationResult<League | null, Error, League, unknown>,
...
const renderWithProviders = (props: Partial<typeof defaultProps> = {}) => {
  return render(
    <I18nextProvider i18n={i18n}>
      <LeagueDetailsModal {...defaultProps} {...props} />
    </I18nextProvider>
  );
};

describe('LeagueDetailsModal', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
  ...
  it('saves changes when Save button is clicked', async () => {
    ...
    await act(async () => {
      renderWithProviders({
        updateSeasonMutation: updateMutation as unknown as UseMutationResult<League | null, Error, League, unknown>,
        onClose,
      });
    });
