  ...
  return (
    <div className="relative flex flex-col h-screen h-[100dvh] bg-slate-900 text-white overflow-hidden">
      ...
      <div className="relative z-10 flex-1 min-h-0 overflow-y-auto flex flex-col px-6 pt-4 pb-4 [@media(min-height:720px)]:pt-6 [@media(min-height:720px)]:pb-6 pb-safe">
        ...
        <div className={`flex-1 flex flex-col justify-start ${dashboardOn ? 'pt-1 [@media(min-height:720px)]:pt-12 [@media(min-height:820px)]:pt-16' : 'pt-3 [@media(min-height:720px)]:pt-6'}`}>
