  ...
  return (
    <div className={CARD} data-testid="translate-report">
      ...
      <select
        ...
        className="w-full mb-3 px-3 py-2 rounded-md bg-slate-800 border border-slate-600 text-sm text-slate-100 focus:outline-none focus:ring-1 focus:ring-purple-500"
      >
