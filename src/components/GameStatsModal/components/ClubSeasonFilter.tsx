  ...
  return (
    <div className="flex items-center gap-2 min-w-0">
      <select
        ...
        className={`flex-1 min-w-0 px-3 py-1 bg-slate-700 border border-slate-600 rounded-md text-slate-200 text-sm focus:outline-none focus:ring-1 focus:ring-purple-500 ${
      ...
      <button
        ...
        className={`p-1.5 rounded-md bg-slate-700 border border-slate-600 text-slate-300 hover:text-purple-400 hover:border-purple-500 transition-colors ${
          !hasConfigured && !isLoading ? 'animate-pulse ring-2 ring-purple-500' : ''
        }`}
