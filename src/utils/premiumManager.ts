 ...
 * Matches tokens generated by:
 * - UpgradePromptModal: 'test-internal-{timestamp}' or 'test-preview-{timestamp}'
 * - playBilling.ts mock: 'test-{timestamp}-{random}'
 */
const TEST_TOKEN_PATTERN = /^test-/;
