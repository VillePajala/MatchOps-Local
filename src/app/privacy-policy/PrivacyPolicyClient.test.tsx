  ...
  useTranslation: () => ({
    t: (key: string) => {
      const translations: Record<string, string> = {
        ...
        'privacyPolicy.voiceNotesAndAi.title': 'Voice Notes and Optional AI',
        'privacyPolicy.voiceNotesAndAi.intro': 'Voice notes are handled like this:',
        'privacyPolicy.voiceNotesAndAi.items.onDevice': 'Recordings stay on your device.',
        'privacyPolicy.voiceNotesAndAi.items.deleted': 'Deleted on accept, discard, or after 30 days.',
        'privacyPolicy.voiceNotesAndAi.items.notes': 'Saved notes are game data.',
        'privacyPolicy.voiceNotesAndAi.items.neverReceived': 'MatchOps never receives recordings.',
        'privacyPolicy.voiceNotesAndAi.aiTitle': 'Optional AI provider (your own account)',
        'privacyPolicy.voiceNotesAndAi.aiIntro': 'If you connect your own provider:',
        'privacyPolicy.voiceNotesAndAi.aiItems.yourAccount': 'Sent under your own account and key.',
        'privacyPolicy.voiceNotesAndAi.aiItems.onlyOnAction': 'Only when you press Transcribe or Draft.',
        'privacyPolicy.voiceNotesAndAi.aiItems.providerTerms': 'Provider retention under its own terms.',
        'privacyPolicy.voiceNotesAndAi.aiItems.pseudonymized': 'Names replaced with codes before drafting.',
        'privacyPolicy.voiceNotesAndAi.aiItems.disconnect': 'Disconnect and delete anytime.',
