...
- `src/hooks/useAutoSave.ts` - Primary auto-save implementation with retry logic and tiered debouncing
- `src/components/HomePage/hooks/useGamePersistence.ts` - Game persistence orchestration (uses useAutoSave)
