...
- **Reminder**: Plan migration of `playerAssessments` into `GameSessionState` in a future phase to eliminate the split-brain persistence noted in `useGamePersistence`.
