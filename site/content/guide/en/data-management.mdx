...
View your storage usage in Settings:
...
- **Club Season Configuration** - Customize season calendar (default: October-May)
- **Language** - Switch between English and Finnish
- **Theme** - Light/dark mode preference
- **Notification Settings** - Substitution reminder preferences
